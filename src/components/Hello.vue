<template>
  <div class="hello">
    ...
    <a href="http://www.xuechenlei.com">
      <button type="button" class="btn btn-default btn-lg">back blog</button>
    </a>
    <router-link to="item">
      <button type="button" class="btn btn-info btn-lg">start testing</button>
    </router-link>
  </div>
</template>
